...
lines <- c()
for (i in 1:length(comp)){
  for (j in (x <- 0:39)){ #functions with up to 100 dimensions
    for (d in c(30)){
      lines <- c(lines, paste("--competition ", comp[i]," --problem ",j," --dimensions ",d,sep=""))
    }
  }
...
comp <- c("3")
for (i in 1:length(comp)){
  for (j in (x <- 40:49)){ #functions with up to 100 dimensions
    for (d in c(30)){
      lines <- c(lines, paste("--competition ", comp[i]," --problem ",j," --dimensions ",d,sep=""))
    }
  }
...
lines <- c()
for (i in 1:length(comp)){
  for (j in (x <- 26:39)){ #functions with up to 100 dimensions
    for (d in c(30)){
      lines <- c(lines, paste("--competition ", comp[i]," --problem ",j," --dimensions ",d,sep=""))
    }
  }
...
######################################################################
#### Test instances 2, 10, 30, 50, 100, 200, 500 and 1000 dimensions 
######################################################################
...
comp <- c("3") #MIXTURE
for (i in 1:length(comp)){
  for (j in c(0,4,5,7,8,9,12,14,16,18,20,26,27,28,29,30,31,32,33)){
    for (d in c(200,500)){
      lines <- c(lines, paste("--competition ", comp[i]," --problem ",j," --dimensions ",d,sep=""))
    }
  }
