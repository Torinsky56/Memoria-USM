...
for i in {0..9}; do
    carpetaActual="./baseTuning_SF_TRAIN_ALL_MUL_50_3_S$i/respaldosSPSO11"
    logFile="$carpetaActual/EVOCA.log_SPSO11_train_ALL_mul.inst_S$i"
